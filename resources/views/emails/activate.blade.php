...
<div class='background-gradient'>
    ...
    <div class='z-50 flex flex-col items-center justify-center mt-10 w-full px-4'>
      <div class='flex justify-center items-center text-white space-x-4 mb-10'>
        <h1 class="text-4xl md:text-6xl lg:text-8xl text-white font-bold" style="text-shadow: 2px 2px 16px rgba(0,0,0,0.5);">
      ...
      <div class='relative mx-auto p-4 w-full md:max-w-2xl lg:max-w-3xl bg-white bg-opacity-90 rounded-xl shadow-xl'>
        <div class='flex flex-col md:flex-row items-center justify-around'>
          ...
          <h1 class="text-2xl md:text-2xl lg:text-4xl text-white mb-4 font-bold">مرحبًا بك، {{ $user->name }}</h1>
                    <p class="text-xl mb-4 text-white">يمكنك تفعيل حسابك بالضغط على زر تفعيل الحساب</p>  
